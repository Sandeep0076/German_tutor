    ...
    },
    {
        ...
        days: [
            ...
            },
            {
                ...
                focus: "für, um, durch, ohne, gegen (DOGFU)",
                activities: ["Accusative prepositions", "Time expressions", "Directional phrases"],
                homework: ["DOGFU preposition exercises with all genders"],
                details: {
                    sections: [
                        {
                            title: "1. Understanding Prepositions and Cases",
                            content: "Prepositions are small but powerful words that show relationships between things in space, time, and logic. In German, prepositions are crucial because they **govern cases** - meaning they determine which case the following noun must take.\n\n**What Are Prepositions?**\nPrepositions connect nouns/pronouns to other parts of the sentence, showing relationships like:\n* **Location:** in, on, under, through, around\n* **Time:** at, during, before, after, for\n* **Direction:** to, toward, through, into\n* **Other relationships:** without, for, against, with\n\n**The Three Types of Prepositions:**\n\n**1. Always Accusative (DOGFU):**\nThese prepositions ALWAYS require the accusative case:\n* **D**urch, **O**hne, **G**egen, **F**ür, **U**m\n* **Memory trick:** DOGFU or \"Dogs Often Get Fed Treats\"\n\n**2. Always Dative (you'll learn later):**\n* aus, bei, mit, nach, seit, von, zu\n\n**3. Two-Way Prepositions:**\n* Can take EITHER accusative OR dative depending on meaning\n* in, an, auf, über, unter, vor, hinter, neben, zwischen\n\n**Today's Focus: DOGFU Prepositions**\nThese ALWAYS use accusative case, which means:\n* **Masculine articles change:** der → den, ein → einen\n* **Feminine stays same:** die → die, eine → eine\n* **Neuter stays same:** das → das, ein → ein\n* **Plural stays same:** die → die\n\n**Why Learn These First?**\nThese prepositions are extremely common in everyday German and follow a simple, consistent rule - they ALWAYS use accusative. No exceptions!",
                            examples: [
                                { german: "Ich gehe durch den Park.", english: "I go through the park. (durch + accusative)" },
                                { german: "Das Geschenk ist für meine Mutter.", english: "The gift is for my mother. (für + accusative)" },
                                { german: "Wir spielen gegen das Team.", english: "We play against the team. (gegen + accusative)" },
                                { german: "Er kommt ohne seinen Bruder.", english: "He comes without his brother. (ohne + accusative)" },
                                { german: "Wir sitzen um den Tisch.", english: "We sit around the table. (um + accusative)" }
                            ]
                        },
                        {
                            title: "2. DURCH - Through/By Means Of",
                            content: "**DURCH** is a versatile preposition with two main meanings: spatial (through) and instrumental (by means of).\n\n**Meaning 1: Through (Spatial)**\nIndicates movement through a space or object:\n* Ich gehe durch den Park. (I walk through the park.)\n* Der Zug fährt durch den Tunnel. (The train goes through the tunnel.)\n* Wir schauen durch das Fenster. (We look through the window.)\n\n**Meaning 2: By Means Of (Instrumental)**\nIndicates the method or means:\n* Ich lerne durch Übung. (I learn through practice.)\n* Er wird durch Arbeit reich. (He becomes rich through work.)\n\n**Common Expressions:**\n* **durch Zufall** - by chance\n* **durch die Stadt gehen** - to walk through the city\n* **durch dick und dünn** - through thick and thin\n* **durch und durch** - through and through, completely\n\n**Grammar Reminder:**\nDURCH always takes accusative:\n* der Park → durch **den** Park\n* der Tunnel → durch **den** Tunnel\n* das Fenster → durch **das** Fenster (neuter - no change)\n* die Stadt → durch **die** Stadt (feminine - no change)",
                            examples: [
                                { german: "Ich gehe durch den Wald.", english: "I walk through the forest." },
                                { german: "Das Licht kommt durch das Fenster.", english: "The light comes through the window." },
                                { german: "Er lernt Deutsch durch Filme.", english: "He learns German through films." },
                                { german: "Wir fahren durch die Stadt.", english: "We drive through the city." },
                                { german: "Sie wird durch Fleiß erfolgreich.", english: "She becomes successful through diligence." }
                            ]
                        },
                        {
                            title: "3. OHNE - Without",
                            content: "**OHNE** means 'without' and is one of the most frequently used accusative prepositions.\n\n**Basic Usage:**\nOHNE indicates the absence of something or someone:\n* Ich gehe ohne meinen Freund. (I go without my friend.)\n* Kaffee ohne Zucker, bitte. (Coffee without sugar, please.)\n* Sie lebt ohne Angst. (She lives without fear.)\n\n**Important Notes:**\n\n**1. OHNE vs. MIT:**\n* **ohne** (without) + ACCUSATIVE\n* **mit** (with) + DATIVE (you'll learn later)\n\n**2. Articles Often Omitted:**\nWith abstract/uncountable nouns, articles are often dropped:\n* ohne Geld (without money)\n* ohne Probleme (without problems)\n* ohne Angst (without fear)\n\nBut with specific, countable nouns, use the article:\n* ohne den Hund (without the dog)\n* ohne meinen Bruder (without my brother)\n\n**Common Expressions:**\n* **ohne Zweifel** - without doubt\n* **ohne Weiteres** - without further ado\n* **ohne mich!** - count me out!\n* **ohne Ende** - endlessly\n\n**Grammar Reminder:**\nOHNE takes accusative:\n* der Freund → ohne **den** Freund\n* mein Bruder → ohne **meinen** Bruder",
                            examples: [
                                { german: "Ich kann nicht ohne dich leben.", english: "I can't live without you." },
                                { german: "Er trinkt Kaffee ohne Milch.", english: "He drinks coffee without milk." },
                                { german: "Ohne meinen Pass kann ich nicht reisen.", english: "Without my passport I can't travel." },
                                { german: "Sie geht ohne ihre Schwester.", english: "She goes without her sister." },
                                { german: "Ohne Fleiß kein Preis.", english: "No pain, no gain." }
                            ]
                        },
                        {
                            title: "4. GEGEN - Against/Around (Time)/Toward",
                            content: "**GEGEN** is multifaceted with three distinct meanings.\n\n**Meaning 1: Against (Opposition)**\nIndicates opposition or conflict:\n* Wir spielen gegen Bayern München. (We play against Bayern Munich.)\n* Das Auto fährt gegen den Baum. (The car drives into the tree.)\n* Ich bin gegen diese Idee. (I'm against this idea.)\n\n**Meaning 2: Around (Approximate Time)**\nIndicates approximate time:\n* Ich komme gegen 8 Uhr. (I'll come around 8 o'clock.)\n* Wir treffen uns gegen Mittag. (We'll meet around noon.)\n\n**Meaning 3: Toward (Direction)**\nIndicates direction:\n* Wir fahren gegen Norden. (We drive toward the north.)\n\n**GEGEN vs. UM for Time:**\n* **gegen** = around, approximately (gegen 8 Uhr = around 8)\n* **um** = at, exactly (um 8 Uhr = at 8 sharp)\n\n**Common Expressions:**\n* **gegen den Strom schwimmen** - swim against the current\n* **etwas gegen etwas haben** - to have something against something\n* **Medizin gegen Kopfschmerzen** - medicine for headaches\n\n**Grammar Reminder:**\nGEGEN takes accusative:\n* der Baum → gegen **den** Baum\n* die Wand → gegen **die** Wand",
                            examples: [
                                { german: "Wir spielen gegen den Champion.", english: "We play against the champion." },
                                { german: "Ich komme gegen 7 Uhr nach Hause.", english: "I come home around 7 o'clock." },
                                { german: "Er lehnt sich gegen die Wand.", english: "He leans against the wall." },
                                { german: "Hast du etwas gegen meinen Plan?", english: "Do you have something against my plan?" },
                                { german: "Das ist ein Mittel gegen Erkältung.", english: "That's a remedy for colds." }
                            ]
                        },
                        {
                            title: "5. FÜR - For",
                            content: "**FÜR** is one of the most common German prepositions, equivalent to English 'for'.\n\n**Meaning 1: For Someone (Beneficiary)**\n* Das Geschenk ist für meinen Vater. (The gift is for my father.)\n* Ich koche für meine Familie. (I cook for my family.)\n\n**Meaning 2: For Something (Purpose)**\n* Ich brauche Geld für das Auto. (I need money for the car.)\n* Das ist gut für die Gesundheit. (That's good for health.)\n\n**Meaning 3: For (Duration)**\n* Ich fahre für zwei Wochen nach Berlin. (I'm going to Berlin for two weeks.)\n\n**Meaning 4: In Favor Of**\n* Ich bin für diese Idee. (I'm for this idea.)\n\n**Meaning 5: In Exchange For**\n* Ich kaufe das Auto für 5000 Euro. (I buy the car for 5000 euros.)\n\n**Common Expressions:**\n* **für immer** - forever\n* **für mich** - for me, in my opinion\n* **Schritt für Schritt** - step by step\n* **Tag für Tag** - day by day\n\n**Grammar Reminder:**\nFÜR takes accusative:\n* der Vater → für **den** Vater\n* mein Bruder → für **meinen** Bruder",
                            examples: [
                                { german: "Das Buch ist für meinen Lehrer.", english: "The book is for my teacher." },
                                { german: "Ich arbeite für eine große Firma.", english: "I work for a large company." },
                                { german: "Wir bleiben für drei Tage.", english: "We stay for three days." },
                                { german: "Das ist sehr wichtig für mich.", english: "That's very important for me." },
                                { german: "Er kauft Blumen für seine Frau.", english: "He buys flowers for his wife." }
                            ]
                        },
                        {
                            title: "6. UM - Around/At (Time)",
                            content: "**UM** has two primary meanings: spatial (around) and temporal (at a specific time).\n\n**Meaning 1: Around (Spatial)**\n* Wir sitzen um den Tisch. (We sit around the table.)\n* Der Hund läuft um das Haus. (The dog runs around the house.)\n\n**Meaning 2: At (Exact Time)**\n* Ich komme um 8 Uhr. (I come at 8 o'clock - exactly!)\n* Der Film beginnt um 20:30 Uhr. (The film starts at 8:30 PM.)\n\n**UM vs. GEGEN for Time - Critical Difference:**\n\n**UM = AT (Exact Time):**\n* um 8 Uhr = at 8 o'clock (precisely)\n* Use when you need to be punctual!\n\n**GEGEN = AROUND (Approximate Time):**\n* gegen 8 Uhr = around 8 o'clock\n* Use when time is flexible!\n\n**Examples:**\n* Der Zug fährt **um** 10 Uhr ab. (at 10 - be on time!)\n* Ich komme **gegen** 10 Uhr. (around 10 - flexible)\n\n**Common Expressions:**\n* **um die Ecke** - around the corner\n* **um Gottes Willen!** - for God's sake!\n* **um jeden Preis** - at any price\n\n**Special: UM...ZU (In Order To)**\n* Ich lerne Deutsch, um in Deutschland zu arbeiten. (I learn German in order to work in Germany.)\n\n**Grammar Reminder:**\nUM takes accusative:\n* der Tisch → um **den** Tisch\n* die Ecke → um **die** Ecke",
                            examples: [
                                { german: "Wir treffen uns um 9 Uhr.", english: "We meet at 9 o'clock (exactly)." },
                                { german: "Die Kinder spielen um den Baum.", english: "The children play around the tree." },
                                { german: "Der Unterricht beginnt um 8:30 Uhr.", english: "The class starts at 8:30." },
                                { german: "Das Geschäft ist um die Ecke.", english: "The shop is around the corner." },
                                { german: "Ich rufe dich um 15 Uhr an.", english: "I'll call you at 3 PM." }
                            ]
                        },
                        {
                            title: "7. Accusative Pronouns with DOGFU",
                            content: "When using DOGFU prepositions with pronouns, use accusative forms.\n\n**Accusative Personal Pronouns:**\n* **ich → mich** (me)\n* **du → dich** (you)\n* **er → ihn** (him)\n* **sie → sie** (her)\n* **es → es** (it)\n* **wir → uns** (us)\n* **ihr → euch** (you all)\n* **sie → sie** (them)\n* **Sie → Sie** (you formal)\n\n**Common Combinations:**\n\n**OHNE + Pronoun (Very Common!):**\n* ohne mich (without me)\n* ohne dich (without you)\n* ohne ihn/sie (without him/her)\n\n**FÜR + Pronoun:**\n* für mich (for me)\n* für dich (for you)\n* für uns (for us)\n\n**GEGEN + Pronoun:**\n* gegen mich (against me)\n* gegen dich (against you)\n\n**Practical Patterns:**\n* Ich kann nicht ohne dich leben. (I can't live without you.)\n* Das ist wichtig für mich. (That's important for me.)\n* Bist du gegen mich? (Are you against me?)\n\n**Common Mistakes:**\n* ❌ ohne ich → ✅ ohne mich\n* ❌ für du → ✅ für dich\n* ❌ gegen er → ✅ gegen ihn",
                            examples: [
                                { german: "Ohne dich bin ich traurig.", english: "Without you I'm sad." },
                                { german: "Das Geschenk ist für dich.", english: "The gift is for you." },
                                { german: "Bist du gegen mich oder für mich?", english: "Are you against me or for me?" },
                                { german: "Komm ohne ihn!", english: "Come without him!" },
                                { german: "Wir spielen gegen euch.", english: "We play against you (plural)." },
                                { german: "Für uns ist das kein Problem.", english: "For us, that's no problem." }
                            ]
                        },
                        {
                            title: "8. Common Mistakes to Avoid",
                            content: "**Mistake 1: Using Dative Instead of Accusative**\n❌ durch dem Park, für dem Kind\n✅ durch den Park, für das Kind\n\n**Fix:** DOGFU prepositions ALWAYS take accusative!\n\n**Mistake 2: Forgetting Masculine Changes**\n❌ für mein Vater, ohne ein Freund\n✅ für meinen Vater, ohne einen Freund\n\n**Fix:** Masculine must change: der→den, ein→einen, mein→meinen\n\n**Mistake 3: Confusing UM and GEGEN for Time**\n* **UM** = exact time (um 8 Uhr = at 8 sharp)\n* **GEGEN** = approximate (gegen 8 Uhr = around 8)\n\n**Mistake 4: Wrong Pronoun Forms**\n❌ ohne ich, für du\n✅ ohne mich, für dich\n\n**Fix:** Use accusative pronouns: mich, dich, ihn, sie, uns, euch\n\n**Mistake 5: Omitting Articles When Needed**\n❌ durch Park, für Vater\n✅ durch den Park, für meinen Vater\n\n**Fix:** Only omit articles with abstract/uncountable nouns (ohne Geld, ohne Angst)\n\n**Memory Tricks:**\n* **DOGFU** = Dogs Often Get Fed Treats\n* **Masculine accusative** = think 'N' for deN, eineN, meineN\n* **UM vs GEGEN** = UM is Exact, GEGEN is General",
                            examples: [
                                { german: "✅ durch den Park ❌ durch dem Park", english: "through the park" },
                                { german: "✅ für meinen Bruder ❌ für mein Bruder", english: "for my brother" },
                                { german: "✅ um 8 Uhr (exact) vs gegen 8 Uhr (approx)", english: "at 8 vs around 8" },
                                { german: "✅ ohne dich ❌ ohne du", english: "without you" }
                            ]
                        },
                        {
                            title: "9. Real-Life Applications",
                            content: "DOGFU prepositions appear constantly in everyday German. Here's how to use them in real situations:\n\n**Giving Directions:**\n* Gehen Sie durch den Park. (Go through the park.)\n* Das Geschäft ist um die Ecke. (The shop is around the corner.)\n\n**Making Appointments:**\n* Der Termin ist um 10 Uhr. (The appointment is at 10.)\n* Ich komme gegen Mittag. (I'll come around noon.)\n\n**Shopping:**\n* Ich suche ein Geschenk für meine Mutter. (I'm looking for a gift for my mother.)\n* Haben Sie etwas für Kinder? (Do you have something for children?)\n\n**Expressing Opinions:**\n* Ich bin für diese Idee. (I'm for this idea.)\n* Ich bin gegen Gewalt. (I'm against violence.)\n\n**Sports:**\n* Wir spielen gegen Bayern München. (We play against Bayern Munich.)\n\n**Health:**\n* Haben Sie etwas gegen Kopfschmerzen? (Do you have something for headaches?)\n\n**Useful Conversation Patterns:**\n* Treffen wir uns um 8 Uhr oder gegen 8 Uhr?\n* Ich komme ohne mein Auto.\n* Das ist wichtig für mich.\n* Können Sie mir helfen? Ich suche ein Geschenk für meinen Vater.",
                            examples: [
                                { german: "Wie komme ich durch die Stadt?", english: "How do I get through the city?" },
                                { german: "Der Arzt hat Zeit um 15 Uhr.", english: "The doctor has time at 3 PM." },
                                { german: "Ich kaufe Blumen für meine Frau.", english: "I buy flowers for my wife." },
                                { german: "Bist du für oder gegen den Plan?", english: "Are you for or against the plan?" },
                                { german: "Deutschland spielt gegen Frankreich.", english: "Germany plays against France." }
                            ]
                        }
                    ],
                    homework: [
